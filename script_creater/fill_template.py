...
log_textbox.grid(row=7, column=2, sticky="ew",columnspan=2)
#end row8

#row9
loadprofile_button= tk.Button(root, text ="08.LOAD PROFILE & CREATE SCRIPT",     command = loadprofile)
loadprofile_button.grid(row=8, column=2, sticky="ew", columnspan=2)
...
status_label.grid(row=9, column=1, columnspan=3)
##end row10
