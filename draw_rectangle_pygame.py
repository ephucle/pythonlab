...
def main():
    ...
    pygame.draw.circle(DISPLAY, PURPLE, (X//2, Y//2), 100)
    pygame.draw.rect(DISPLAY,GREEN,(0,0,100,100)) #test diem goc, corner 1, goc tren ben trai
    pygame.draw.rect(DISPLAY,LIGHTPURPLE,(X-100,0,X,100)) #test diem goc, corner 2, goc tren ben phai
    pygame.draw.rect(DISPLAY,LIGHTRED,(X-100,Y-100,X,Y)) #test diem goc, corner 3, goc duoi ben phai
